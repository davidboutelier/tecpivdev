...
% CP2TFORM(MOVINGPOINTS,FIXEDPOINTS,TRANSFORMTYPE,...)
...
if isa(varargin{1},'struct')
    ...
    % TRANS = CP2TFORM(MOVINGPOINTS,FIXEDPOINTS,TRANSFORMTYPE)
    % TRANS = CP2TFORM(MOVINGPOINTS,FIXEDPOINTS,'polynomial',ORDER)        
    % TRANS = CP2TFORM(MOVINGPOINTS,FIXEDPOINTS,'lwm',N)    
